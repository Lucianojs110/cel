...
<h3 class="text-secondary"><?= __('Reporte facturación transfer') ?></h3>
<br>
...
<br>
    ...
    <table id="tabletransfer" class="table table-hover responsive"  style="font-size: 12px; width: 100% ">
        ...
        <tbody>
            ...
            <?php 
               ...
               if(($colocacion2->transferRecepcion)==null){
                $transferRecepcion=null;
                }else{$transferRecepcion = date("d-m-Y", strtotime($colocacion2->transferRecepcion));}
                if(($colocacion2->transferPago)==null){
                    $transferPago=null;
                    }else{$transferPago = date("d-m-Y", strtotime($colocacion2->transferPago));}
               ...
               ?>
                ...
                <td><?= h($transferRecepcion) ?></td>
                <td><?= h($transferPago) ?></td>
                <td><?= h($colocacion2->transferCheque) ?></td>
                <td><?= h($colocacion2->transferImportePesos) ?></td>
                <td><?= h($colocacion2->transferImporteDolar) ?></td>
